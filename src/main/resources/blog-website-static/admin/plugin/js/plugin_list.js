...
function initPage() {
    ...
    $("#addBtn").click(function () {
        parent.openTab('', '添加插件', '/admin/website/plugin/add', "website-plugin-add");
    });
...
function queryTable() {
    table.render({
        elem: '#tableBox',
        url: '/admin/website/article/list',
        method: 'post',
...
function editData(id) {
    parent.openTab('', '编辑插件', '/admin/website/plugin/update/' + id, "website-plugin-update");
}
